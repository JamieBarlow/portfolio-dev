  ...
  return (
    <>
      <section className="projects__hero">
        <div className="project__header wrapper" ref={navRef}>
          <h1 className="observed">
            <span className="svg--underlined project__underline">
              {title}
        ...
        <div className="bg--blue text--light">
          <div className="project__info wrapper my-4 p-3">
