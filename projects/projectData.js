const projectData = {
    ...
    schillingerRtm: {
        ...
        about: 'Working in collaboration with a composer and specialist in the Schillinger System of Musical Composition, the aim of this project is to develop an application which can generate rhythms based on a numerical user input. It can serve as a tool for sparking creative inspiration, while teaching key elements of Joseph Schillinger\'s rhythmic theory, which can have many creative uses for composers and songwriters.',
        purpose: '',
        features: ['Drum sequencer - can be used like a regular sequencer. Clicking any cell will add or remove a beat', 'Numerical input for users - creates a beat against the pulse', 'Tempo slider for adjusting BPM', 'User-adjustable pattern length (default is 16 beats, or the total length of the user-input beat if entered)', 'Regular/irregular pattern selection'],
        webStack: '',
        description: '',
        challenges: '',
        lessons: '',
