...
const svgElements = [
    <React.Fragment key={"html-css"}>
        <svg viewBox="0 0 128 128" className="devicon">
                <path
                    fill="#E44D26"
    ...
    <svg key="javascript" viewBox="0 0 128 128" className="devicon">
        <path
            fill="#F0DB4F"
    ...
    <svg key="mongoDB" viewBox="0 0 128 128" className="devicon">
    <path
        fillRule="evenodd"
        clipRule="evenodd"
        fill="#439934"
    ...
    <svg key="express" viewBox="0 0 128 128" className="devicon">
        <path
            fill="white"
    ...
    <svg key="react" viewBox="0 0 128 128" className="devicon">
        <g fill="#61DAFB">
    ...
    <svg key="node-js" viewBox="0 0 128 128" className="devicon">
        <path
            fill="#83CD29"
    ...
    <svg key="git-github" viewBox="0 0 128 128" className="devicon">
        <path
            fill="#F34F29"
    ...
    <svg key="bootstrap" viewBox="0 0 128 128" className="devicon">
        <defs>
            <linearGradient
    ...
    <svg key="mocha-js" viewBox="150.1669 156.2779 112 126.3808" className="devicon">
        <g
            fill="#8d6748"
            transform="matrix(1, 0, 0, 1, 142.1668701171875, 155.47296142578125)"
        >
            <path
            d="M 116.42 29.94 L 67.48 1.72 C 65.366 0.5 62.763 0.5 60.65 1.72 L 11.6 29.94 C 9.448 31.11 8.078 33.333 8 35.78 L 8 92.22 C 8.097 94.654 9.453 96.862 11.58 98.05 L 60.52 126.27 C 62.633 127.491 65.236 127.491 67.35 126.27 L 116.4 98.06 C 118.515 96.857 119.871 94.66 120 92.23 L 120 35.78 C 119.905 33.343 118.549 31.13 116.42 29.94 Z"
            style={{ fillRule: "nonzero", fill: "rgb(247, 249, 255)" }}
            ></path>
            <path
            ...
            style={{}}
            ></path>
            <circle cx="40" cy="62.53" r="4.84" style={{}}></circle>
            <path
    ...
    <svg key="figma" viewBox="0 0 128 128" className="devicon">
        <path
            fill="#0acf83"
...
export default function ExperienceIcons() {
    const techList = ["HTML / CSS", "JavaScript", "MongoDB", "Express", "React", "Node.js", "Git / GitHub", "BootStrap", "Mocha.js", "Figma"];
    return (
