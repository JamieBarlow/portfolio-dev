...
export default function Footer() {
  const { location } = useContext(ObserverContext);
        ...
        <ul className="footer__icons">
          <li>
            <a href="https://github.com/JamieBarlow/">
              <svg role="img" aria-label="GitHub" width="25" height="24">
                <path
                  fillRule="evenodd"
          ...
          <li>
            <a href="http://www.linkedin.com/in/jamie-barlow-2b4b3648">
              <svg role="img" aria-label="LinkedIn" width="25" height="24">
                <path
                  fillRule="evenodd"
          ...
          <li>
            <a href="https://twitter.com/JayBarls">
              <svg role="img" aria-label="Twitter" width="24" height="20">
